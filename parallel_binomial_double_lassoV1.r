...
# saveRDS(naive, file = "R_output/naive_binomial_lassoV1.rds") # save the model
...
# # Path plot
# png("R_output/naive_binomial_lasso_pathV1.png", width = 800, height = 600) # save the
...
print(parallel.time)
saveRDS(results, file = "R_output/parallel_lasso_resultsV1.rds")
...
# Save results :)
write.csv(results.df, file = "R_output/parallel_lasso_resultsV1.csv", row.names = FALSE) #false bc we have variable names

#read the results
#results.df <- read.csv("R_output/parallel_lasso_resultsV1.csv")
