...
# Set the job name
#SBATCH --job-name="Binomial_Log"

# Set the partition
#SBATCH --partition=interlagos

# Set the output and error file paths
#SBATCH --output=stat480_project/Binomial/out_log.out
#SBATCH --error=stat480_project/Binomial/err_log.err
...
python /u/gfs3/Project/DSRS/gfs3/stat480_project/Binomial/binomial_logreg.py
